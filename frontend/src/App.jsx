...
// Dados falsos para testar o visual (Mock)
const ANIMAIS_MOCK = [
  ...
  return (
    <div className="bg-[#F5F2ED] min-h-screen font-sans text-[#2D2D2D]">
      ...
      <section className="pt-24 pb-16 px-6 text-center max-w-4xl mx-auto">
        ...
        <button className="bg-[#E26A45] text-white px-10 py-4 rounded-lg font-bold text-lg hover:shadow-lg transition-all">
      ...
      <section className="py-24 text-center border-t border-gray-200">
        ...
        <button className="bg-[#E26A45] text-white px-12 py-4 rounded-lg font-bold text-xl">
          Cadastrar minha organização
        </button>
